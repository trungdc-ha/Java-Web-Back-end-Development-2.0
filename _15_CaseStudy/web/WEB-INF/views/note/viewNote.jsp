                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputTitle" name="title" title="title"
                                   value='${requestScope["note"].getTitle()}' readonly/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="content" id="inputContent" title="Content" readonly>${requestScope["note"].getContent()}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input title="typeNoteId" id="inputTypeNote" class="form-control" name="typeNoteId" value='${requestScope["note"].getNoteType().getName()}' readonly>
                        </div>
                    </div>
                </div>
            </fieldset>
