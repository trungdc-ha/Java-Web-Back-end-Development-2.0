                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputTitle" name="title" title="title"
                                   value='${requestScope["note"].getTitle()}'/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="content" id="inputContent" title="Content">${requestScope["note"].getContent()}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select title="typeNoteId" id="inputTypeNote" class="form-control" name="typeNoteId">
                                <c:forEach items="${noteTypes}" var="noteType">
                                    <c:if test="${requestScope['note'].getNoteType().getId()==noteType.getId()}">
                                        <option value="${noteType.getId()}" selected> ${noteType.getName()}</option>
                                    </c:if>
                                    <c:if test="${requestScope['note'].getNoteType().getId()!=noteType.getId()}">
